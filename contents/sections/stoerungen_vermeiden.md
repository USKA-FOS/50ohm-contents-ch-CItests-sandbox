...
Störungen oder störende Beeinflussungen von Geräten können für die betroffenen Personen natürlich mit Unannehmlichkeiten verbunden sein. Wenn die Probleme nur im eigenen Haushalt auftreten, kann man damit vielleicht noch gut umgehen. Wenn es jedoch zu Störungen bei Geräten von Nachbarn kommt, wird es schon schwieriger.

Wenn wir von einem solchen Problem in unserer Umgebung erfahren, sollten wir immer in Betracht ziehen, dass sie mit unserer Amateurfunkanlage im Zusammenhang stehen könnte. Daher sollte ein Funkamateur in solchen Fällen anbieten, zu prüfen, ob er der Verursacher ist.
...
[picture:747:stoerungen_vermeiden_einstroemung:Einströmung über Anschlussleitungen]
</indepth>

---

Man sollte nun nach der Ursache suchen und prüfen, ob man das Problem mit eigenen Mitteln beheben kann. Möglicherweise kann die Ursache allerdings nicht ermittelt bzw. das Problem nicht beseitigt werden. Dann ist es ratsam, den Nachbarn darauf hinzuweisen, dass er sich an die Funkstörungsannahme der Bundesnetzagentur wenden kann.
