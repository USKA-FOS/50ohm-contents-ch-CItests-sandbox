...
Bei der *Kollektorschaltung* fliesst das Eingangssignal von der Quelle über die Basis, den *Kollektor* und die Versorgungsspannung zurück zur Quelle. Das Ausgangssignal fliesst vom Kollektor durch die Last (Senke) und über die Versorgungsspannung zurück in den *Kollektor*.
...
Die Spannungsverstärkung der Kollektorschaltung bewegt sich bei entsprechender Auslegung im Bereich von $\num{0,9}$ bis $\num{0,98}$ und ist immer etwas kleiner als $1$. Die Stromverstärkung der Kollektorschaltung ist hingegen sehr gross, da die Eingangsimpedanz der Schaltung relativ hoch ist. Die Ausgangsimpedanz ist hingegen sehr niedrig im Vergleich zur Eingangsimpedanz.
